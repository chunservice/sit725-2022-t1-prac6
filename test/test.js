...
describe("Add Two Numbers", function() {
    ...
    // test if the api sends us a correct or a failure result
    ...
    // test if the summation result is 8 as we input 3 and 5 in the beginning
    ...
    // test and return the result not equal to 15
    ...
    describe("Add Two strings", function() {
        ...
        // test that output should be null 
